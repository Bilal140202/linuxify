...
import { atomicWriteFile, createBackup } from '../utils/atomic-write.js';
import { TransactionalStateStore } from '../utils/secure-store.js';
 ...
 */
/**
 * Repair checkpoint for rollback support (FIX W8).
 */
interface RepairCheckpoint {
  readonly timestamp: number;
  readonly description: string;
  readonly stateBackup: string;
  readonly filesBackedUp: string[];
}
